...
trait HasSubscriptions
{
    ...
    {
        if ($plan->periodicity) {
            $expiration ??= $plan->calculateNextRecurrenceEnd($startDate);
    ...
    public function giveTicketFor($featureName, $expiration = null, ?float $charges = null): FeatureTicketContract
    {
        ...
        $feature = $this->featureModelQuery()->where('name', $featureName)->firstOrFail();
    ...
    {
        if ($this->loadedSubscriptionFeatures !== null) {
    ...
    protected function loadTicketFeatures(): Collection
    {
        ...
        if ($this->loadedTicketFeatures !== null) {
